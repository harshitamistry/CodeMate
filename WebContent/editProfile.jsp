			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<table class="table table-borderless">
						...
						<tr>
							<td><input type="hidden" id="userHandle"
								value="${userProfile.userHandle}"> <input type="text"
						...
						<tr>
							<td><select class="selectpicker" id="countryDropDown">
									<c:forEach var="country" items="${countryList}">
										...
										<option
											${country.countryName == userProfile.school.country.countryName ? 'selected = "selected"' : '' }
							...
							<td><select class="selectpicker" id="schoolDropDown">
									...
									<c:forEach var="schools" items="${schoolList}">
										<option
											${schools.schoolName == userProfile.school.schoolName ? 'selected = "selected"' : '' }
											value="<c:out value="${schools.schoolId}"/>">
						...
						<tr>
							<td align='center' colspan="2">
								<button type="submit" id='updateUser' class="btn loginButton">Update</button>
							</td>
						</tr>
					</table>
				</div>
