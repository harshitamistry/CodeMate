...
<div class="panel panel-default">
  <div class="panel-body"><h3 align="center">Hello <%=session.getAttribute("userHandle")%>!</h3>
   ...
   <tr>
   <td><img alt="" src="${userProfile.awards.badgePicture}" class="profile_smiley"> &nbsp;
   <span class="user_award_title"><c:out value="${userProfile.awards.title}"/></span>
   <h2><c:out value="${userProfile.points}"/>&nbsp;Points</h2>
   </td>
   ...
   <tr><td align='center' colspan="2"> <button type="submit" id='editProfile' class="btn loginButton">Edit Profile</button></td></tr>
