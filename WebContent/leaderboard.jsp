...
<!-- Showing list of leaders in a table format -->
<div class="container">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<div id="dropdownsLeaderboard">
				<select class="selectpicker" id="countryDropDownLB">
					...
					<option selected="selected" value="All Countries">All
						Countries</option>
				...
				</select> <select class="selectpicker" id="schoolDropDownLB">
				...
				<tbody id="LBbody">
					...
					<c:forEach items="${topTen}" var="user">
						<tr>
							...
							<td><img
								src="/CodeMateMVC/LeaderBoard?query=getFlag&userId=${user.userId}"
