...
<%
	if ((session.getAttribute("userHandle") == null
			|| session.getAttribute("userHandle").equals(""))
			&& !request.getRequestURI()
					.equals("/CodeMateMVC/SignUp.jsp")
			&& !request.getRequestURI()
					.equals("/CodeMateMVC/index.jsp")
			&& !request.getRequestURI()
					.equals("/CodeMateMVC/SignUp")) {
...
<script
	src="//cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.0.1/fullcalendar.min.js"></script>
<link rel="stylesheet"
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content ">
					<div class=" modal-header red_modal_header">
						...
						<h4 class="modal-title run_message" id="error_label">Login
							unsuccessful</h4>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-4 col-md-2">
					<a href="/CodeMateMVC/Home.jsp"> <img src="_images/logo.png"
						height="50" width="227" class="headerImage"></a>
				</div>
				<c:choose>
					<c:when test="${sessionScope.userHandle == null}">
						<div class="form-inline">
							<div class="form-group col-md-2 col-md-offset-2 login">
								<input type="text" class="form-control" id="loginUname"
...
<button class="btn imgSize" id="facebookBtn"></button>
					...
					<c:otherwise>
						<div class="btn-group col-xs-4 col-md-1 col-md-offset-7 dropdown"
							id="gotoDDCol">
							<a class="btn dropdown-toggle DD" data-toggle="dropdown"
								id="dropdownMenuUser" aria-haspopup="true" aria-expanded="false">
						...
						<div class="btn-group col-xs-4 col-md-2 dropdown" id="userDDCol">
							<a class="btn dropdown-toggle DD" data-toggle="dropdown"
								id="dropdownMenuUser" aria-haspopup="true" aria-expanded="false">
								<span id="userImageDD"><div class="circleDiv">
										<img src="_images/user.png" id="userImage" />
									</div></span> <span class="titleDD" id="userNameDD"><%=session.getAttribute("userHandle")%></span>
							</a>
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuUser"
								class="DDul">
