...
<!-- scripts reference source for code highlighter http://codemirror.net
 -->
<script type="text/javascript" src="_js/contestProblem.js"></script>
...
<!-- To show problem content, code editor and terminal in three vertical panels -->
<div class="tutorial_containers">
	...
	<div class="tutorial">
		...
		<div id="problemContent" data-id="<%=request.getParameter("id")%>">
			...
			<h2>
				<c:out value="${contestProblem.problemName}" />
			</h2>
			<p>
				<c:out value="${contestProblem.problemQuestion}" escapeXml="false" />
			</p>
		</div>
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content ">
					...
					<div class="modal-footer">
						...
						<button type="button"
							onclick="window.location='/CodeMateMVC/Competitions'"
							class="btn loginButton">Contest problems</button>
